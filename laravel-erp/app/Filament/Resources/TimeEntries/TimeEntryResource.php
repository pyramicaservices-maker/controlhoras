...
class TimeEntryResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Historial de Horas';
    protected static ?string $modelLabel = 'Registro de Tiempo';
    protected static ?string $pluralModelLabel = 'Registros de Tiempos';
